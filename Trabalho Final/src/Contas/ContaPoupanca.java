...
public class ContaPoupanca extends Conta{
    Banco ContPoupanca = new Banco();
    public ContaPoupanca(int NumConta,String nome,float Saldo,String senha,int tipo) {
            super(NumConta, nome, Saldo, senha, tipo);
    }
    public void Cad() {

        ContPoupanca.conectar();
        ...
        PreparedStatement prepare = ContPoupanca.criarPreparedStatement(sql);
